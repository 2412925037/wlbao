 ...
 * 已失效订单
 */
public class ExpiredBillsActivity extends BaseActivity implements OnRefreshListener, OnLoadMoreListener {
...
//        http://app.yasbao.com/Home/Api/gw?api=yasbao.api.order.orderlist&uid= &apiKey=&status=&p=
        ...
        new OkHttpUtils().getDatas(this,url, session, new OkHttpUtils.HttpCallBack() {
            ...
            public void onSusscess(String data) {
                ...
                if (TextUtils.equals(bean.getResult().trim(), "SUCESS")) {
                    ...
                    ToastUtils.toastForLong(ExpiredBillsActivity.this,bean.getWorngMsg());
                    ExpiredBillsActivity.this.finish();
                    startActivity(new Intent(ExpiredBillsActivity.this, LoginActivity.class));
                }
                else {
                    lrvMyBills.setVisibility(View.GONE);
                    emptyView.setVisibility(View.VISIBLE);
                    ToastUtils.toastForShort(ExpiredBillsActivity.this, bean.getWorngMsg());
                }
            }
            ...
            public void onError(String meg) {
                ...
                ToastUtils.toastForLong(ExpiredBillsActivity.this, "请求失败!");
            }
        });
    }
    ...
    private void initViews() {
        ...
        tvMiddleTitle.setText("已失效订单");
        titleRightOneBtn.setVisibility(View.VISIBLE);
        new GlideImageLoader(ExpiredBillsActivity.this).display(titleRightOneBtn, R.mipmap.icon_search);

        lrvMyBills.setLayoutManager(new LinearLayoutManager(ExpiredBillsActivity.this));
        myBillsAdapter = new MyBillsAdapter(ExpiredBillsActivity.this,false);
        adapter = new LRecyclerViewAdapter(myBillsAdapter);
        lrvMyBills.setAdapter(adapter);
        adapter.setOnItemClickListener(new OnItemClickListener() {
            @Override
            public void onItemClick(View view, int position) {
                Intent intent = new Intent(ExpiredBillsActivity.this, BillDetailActivity.class);
        ...
        DividerDecoration decoration = new DividerDecoration.Builder(ExpiredBillsActivity.this)
    ...
    public void onViewClicked(View view) {
        switch (view.getId()) {
            ...
            case R.id.title_right_one_btn:
                Intent intent = new Intent(ExpiredBillsActivity.this, TaoBaoSearchActivity.class);
                startActivity(intent);
                break;
        }
    }
