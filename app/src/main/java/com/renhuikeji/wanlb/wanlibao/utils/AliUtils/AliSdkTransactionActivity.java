...
public class AliSdkTransactionActivity extends AppCompatActivity {
    ...
    private final static String PID = "mm_122696423_0_0";
    ...
    public void showUrl(View view) {
        ...
        if(TextUtils.isEmpty(text)) {
            ToastUtils.toastForShort(AliSdkTransactionActivity.this, "URL为空");
            return;
        };
    ...
    public void addToCart(View view) {
        ...
        if (isTaoke) {
            alibcTaokeParams = new AlibcTaokeParams(PID, PID, null);
        } else {
            alibcTaokeParams = null;
        }
    ...
    public void defaultChecked(View view) {
        ...
        if (isChecked) {
            ...
            ToastUtils.toastForShort(this, ((RadioButton) view).getText().toString());
        }
    }
