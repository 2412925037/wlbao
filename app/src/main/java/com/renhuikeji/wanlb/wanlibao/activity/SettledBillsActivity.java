 ...
 * 已结算订单
 */
public class SettledBillsActivity extends BaseActivity implements OnRefreshListener, OnLoadMoreListener {
...
//                    page=Integer.parseInt(bean.getPage());
                    ...
                    ToastUtils.toastForShort(SettledBillsActivity.this, bean.getWorngMsg());
                    SettledBillsActivity.this.finish();
                    startActivity(new Intent(SettledBillsActivity.this, LoginActivity.class));
                }else {
            ...
            public void onError(String meg) {
                ...
                ToastUtils.toastForLong(SettledBillsActivity.this, "请求失败!");
            }
        });
    }
    ...
    private void initViews() {
        ...
        new GlideImageLoader(SettledBillsActivity.this).display(titleRightOneBtn, R.mipmap.icon_search);
        lrvMyBills.setLayoutManager(new LinearLayoutManager(SettledBillsActivity.this));
        myBillsAdapter = new MyBillsAdapter(SettledBillsActivity.this,false);
        adapter = new LRecyclerViewAdapter(myBillsAdapter);
        lrvMyBills.setAdapter(adapter);
        adapter.setOnItemClickListener(new OnItemClickListener() {
            @Override
            public void onItemClick(View view, int position) {
                Intent intent = new Intent(SettledBillsActivity.this, BillDetailActivity.class);
                startActivity(intent);
            }
        });

        DividerDecoration decoration = new DividerDecoration.Builder(SettledBillsActivity.this)
...
//        lrvMyBills.addItemDecoration(decoration);
        ...
        adapter.setOnItemClickListener(new OnItemClickListener() {
            @Override
            public void onItemClick(View view, int position) {
                Intent i=new Intent(SettledBillsActivity.this, BillDetailActivity.class);
    ...
    public void onViewClicked(View view) {
        switch (view.getId()) {
            ...
            case R.id.title_right_one_btn:
                Intent intent = new Intent(SettledBillsActivity.this, TaoBaoSearchActivity.class);
                startActivity(intent);
                break;
        }
    }
