 ...
 * 转账提现
 */
public class WeChatCashActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_we_chat_cash);
        ...
        mHandler = new Handler() {
            ...
            public void handleMessage(Message msg) {
                switch (msg.what) {
                    case 1:
                        dialog = DialogUtils.getMaterialDialogOneBtn(WeChatCashActivity.this, "首次提现请先关注万利宝微信公众号(yasbao)," +
        ...
        suid = (String) SPUtils.get(WeChatCashActivity.this, Constant.User_Uid, "");
        gson = new Gson();
        imageloader = new GlideImageLoader(WeChatCashActivity.this);
    ...
    private void getUserInfo() {
        ...
        String msession = (String) SPUtils.get(WeChatCashActivity.this, Constant.MSESSION, "");
        new OkHttpUtils().getDatas(this,url, msession, new OkHttpUtils.HttpCallBack() {
            ...
            public void onSusscess(String data) {
                ...
                if (TextUtils.equals("SUCESS", bean.getResult())) {
                    ...
                    ToastUtils.toastForLong(WeChatCashActivity.this, "用户信息获取失败");
                }
            ...
            public void onError(String meg) {
                ...
                ToastUtils.toastForShort(WeChatCashActivity.this, getResources().getString(R.string.bad_net));
            }
        });
    }
    ...
    private boolean checkInfo() {
        ...
        if (TextUtils.isEmpty(openid_yasbao)) {
            ToastUtils.toastForShort(WeChatCashActivity.this, "请先关注万利宝微信公众号（yasbao）");
            return false;
        }

        if (!TextUtils.isEmpty(money_tixian) && Float.parseFloat(money_tixian) < 1.00) {
            ToastUtils.toastForShort(WeChatCashActivity.this, "转账金额不能小于1元");
    ...
    private void beginTransfer(final String msession) {
        //关闭软键盘
        KeyBoardUtils.closeKeybord(edit_cashMoney, WeChatCashActivity.this);
        DialogUtils.showProgressDlg(WeChatCashActivity.this, "正在提现，请勿操作");
        ...
        new OkHttpUtils().getDatas(this,str_url, msession, new OkHttpUtils.HttpCallBack() {
            ...
            public void onSusscess(String data) {
                ...
                if (TextUtils.equals("WRONG", bean.getResult())) {
                    ToastUtils.toastForShort(WeChatCashActivity.this, bean.getWorngMsg());
                } else {
                    ToastUtils.toastForShort(WeChatCashActivity.this, "提现成功");
                    //发送广播提示修改账户余额
                    Intent intent = new Intent("refreshmoney");
                    intent.putExtra("result", "1");
                    LocalBroadcastManager.getInstance(WeChatCashActivity.this).sendBroadcast(intent);
